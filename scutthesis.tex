...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%——by MCH
%编译范围
\includeonly{chapter/chapter01, chapter/chapter04, chapter/chapter02, chapter/chapter03} % 需要编译的章节，编译时直接在相应章节编译即可，无需切换界面
%参考文献设置
...
\addbibresource[location=local]{biblibrary/ESU.bib}
%页眉页脚设置
\usepackage{fancyhdr}
\usepackage{listings}
\usepackage{xunicode}
\renewcommand{\lstlistingname}{代码列表}
\pagestyle{fancy}
